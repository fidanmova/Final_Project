    ...
    return (
        <div className="w-11/12 lg:w-[65vw] lg:h-[80vh] flex flex-col justify-center items-center  bg-black/50 rounded-xl  shadow-green-500 shadow-md">
            <div className="w-full flex flex-wrap justify-center">
                ...
                />
                <DashCard
                    text="don't miss it! check all monthly events around you"
                    title="events"
                ...
                <DashCard
                    ...
                    title="code"
                    style="text-[#faff00] shadow-[#faff00] w-full h-auto mt-2 hover:scale-95 transition duration-200 ease-in-out"
                />
            </div>
        </div>
    );
