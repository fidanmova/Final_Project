...
const LeftSide = ({ data }) => {
  ...
  return (
    <div className="w-11/12 lg:w-[15vw] lg:h-[80vh] flex flex-col items-center bg-black/50 rounded-lg shadow-red-500 shadow-md text-xs lowercase hover:scale-95 transition duration-200 ease-in-out">
      <h1 className="text-xl my-4 capitalize">Hi {data?.user?.username}</h1>
