...
import { ImPacman, ImLaptop } from "react-icons/im";
            ...
            <button className="flex items-center space-x-4">
                {user !== null ? (
                    ...
                    <div className="flex mr-8 items-center space-x-4">
                        <Link href="/circle">
                            <p className="text-red-500 text-xl rounded-lg hover:bg-red-500/50 hover:text-black p-2">CIRCLE</p>
                        </Link>
                        <Link href="/chat">
                        <p className="text-purple-500 text-xl rounded-lg hover:bg-purple-500/50 hover:text-black p-2">CHAT</p>
                        </Link>{" "}
                        <Link href="/events">
                            <p className="text-blue-500 text-xl rounded-lg hover:bg-blue-500/50 hover:text-black p-2">EVENTS</p>
                        </Link><Link href="/jobs">
                            <p className="text-pink-500 text-xl rounded-lg hover:bg-pink-500/50 hover:text-black p-2">JOBS</p>
                        </Link>
                     </div>
